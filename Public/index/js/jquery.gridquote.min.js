!function (a) {
    a.fn.gridQuote = function (b) {
        ...
        function t() {
            ...
            }), h && (g[Math.min((h.data("row") + 1) * j + h.data("row"), g.length - 1)].after(e), l && a("body, html").animate({scrollTop: h.offset().top}, 300, function () {
                q && r()
            }))
        }

        var c = {titleFontSize: 32, defaultBgColor: "blue", slideshow: !0, slideshowDelay: 5e3, pauseByHover: !0, autoScroll: !0, initOpen: !0};
        b && a.extend(c, b);
        ...
        d.find(".thumb-container").each(function (b) {
            ...
            p.addClass(t).find(".popover-content").css("font-size", s), a(this).on("click", function () {
                ...
                a(this).is(h) ? l ? (e.slideUp("fast"), o && o.stop(!0).animate({opacity: 0}, 300, function () {
                    a(this).hide()
                }), l = !1) : (e.show().slideDown("fast"), o && o.show().stop(!0).animate({opacity: 1}, 300), l = !0) : (o && o.stop(!0).animate({opacity: 0}, 300, function () {
                    a(this).hide()
                }), e.offset().top == i ? e.stop(!0).animate({opacity: 0}, 300, function () {
                    e.html(f).animate({opacity: 1}, 300)
                }) : e.hide().html(f).slideDown("fast"), i = e.offset().top, m = a(this).find(".popover"), m.find(".arrow").show().css("opacity", 1), m.show().stop(!0).animate({opacity: 1}, 400), l = !0, o = m), c.autoScroll && !navigator.userAgent.match(/(iPod|iPhone|iPad)/) && a("body, html").delay(300).animate({scrollTop: a(this).offset().top}, 600, function () {
                    q && r()
                }), h = a(this)
            })
                ...
                if (!navigator.userAgent.match(/(iPod|iPhone|iPad)/) && !a(this).is(h)) {
                    ...
                    c.find(".arrow").hide().css("opacity", 0), c.show().css({opacity: 0}).animate({opacity: 1}, 400)
                }
            }).on("mouseleave", function () {
                a(this).is(h) || a(this).find(".popover").stop(!0).animate({opacity: 0}, 300, function () {
                    a(this).hide()
                })
